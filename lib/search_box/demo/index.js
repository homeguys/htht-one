...
var _warn_box = _interopRequireDefault(require("../../common/warn_box"));
...
function SearchBox(props) {
  const {
    ...
    selectData = [],
    onSubmit
  } = props; // 没传mode或者传horizontal和vertical之外的值，默认是horizontal

  const checked = mode && mode === 'vertical'; // 没传form的话警告，form必传
  ...
  return _react.default.createElement("div", {
    className: `htht-search-box ${className}`
    ...
    className: "title"
  }, "\u5355\u9009\u8981\u7D20\uFF1A"), _react.default.createElement(FormItem, null, getFieldDecorator('radioGroup')(_react.default.createElement(_radio.default.Group, null, radioData.map(item => _react.default.createElement(_radio.default, {
    key: item.value,
    value: item.value
  }, item.name))))))) : null, checkboxData.length ? _react.default.createElement("div", {
    className: "htht-check-choice htht-check-choice-horizontal"
  }, _react.default.createElement("div", {
    className: "item"
  }, _react.default.createElement("span", {
    className: "title"
  }, "\u591A\u9009\u8981\u7D20\uFF1A"), _react.default.createElement(FormItem, null, getFieldDecorator('checkedGroup')(_react.default.createElement(_checkbox.default.Group, null, checkboxData.map(item => _react.default.createElement(_checkbox.default, {
    key: item.value,
    value: item.value
  }, item.name))))))) : null, selectData.length ? _react.default.createElement("div", {
  ...
  }, selectData.map(item => _react.default.createElement(Option, {
    key: item.value,
    value: item.value
  }, item.name))))))) : null, _react.default.createElement(_button.default, {
    type: "primary",
    block: true,
    onClick: onSubmit
  }, "\u63D0\u4EA4"))));
