...
class ChartGauge extends _react.default.Component {
  constructor(props) {
    super(props);
  ...
  renderChart() {
    ...
    this.myChart = _echarts.default.init(document.getElementById(`htht-chart-gauge-${this.hash}`));
    const newOption = (0, _utils.deepObjectMerge)(this.getDefaultOption(value, color), option);
